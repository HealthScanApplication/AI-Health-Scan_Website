...
export function AdminDebugPanel() {
  ...
  return (
    <div
      ...
      style={{ maxHeight: minimized ? '40px' : '360px' }}
    >
      {/* Header */}
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          <button onClick={(e) => { e.stopPropagation(); setMinimized(!minimized); }} className="p-1 hover:bg-gray-700 rounded">
            {minimized ? <ChevronUp className="w-3 h-3 text-gray-400" /> : <ChevronDown className="w-3 h-3 text-gray-400" />}
          </button>
          <button onClick={(e) => { e.stopPropagation(); setOpen(false); }} className="p-1 hover:bg-gray-700 rounded">
