...
/**
 * ============================================================
 *  PROTOCOLS TAB — Full-day health protocols
 * ============================================================
 */
const protocolsFields: FieldConfig[] = [
  {
    key: "id",
    label: "ID (slug)",
    type: "text",
    ...
    showInEdit: true,
    required: true,
    placeholder: "e.g. detox-day, recovery-day",
  },
  {
    key: "name",
    label: "Name",
  ...
  },
  {
    ...
    colorMap: {
      ...
      fasting: "bg-purple-100 text-purple-800",
      sleep: "bg-indigo-100 text-indigo-800",
      gut_health: "bg-yellow-100 text-yellow-800",
      immune: "bg-teal-100 text-teal-800",
      weight_loss: "bg-pink-100 text-pink-800",
    },
  },
  {
    key: "difficulty",
  ...
  },
  {
    ...
    aiSuggest: true,
    aiPrompt:
      "Write a concise 2-3 sentence description of a '{category}' health protocol called '{name}' with difficulty '{difficulty}'. Explain what it involves and who it's suitable for.",
  },
  {
    key: "duration_days",
    label: "Duration (days)",
  ...
  // ── Time Blocks (Night Before → Sleep) ──────────────────────
  {
    key: "night_before",
    label: "Night Before",
    type: "json",
    ...
    showInEdit: true,
    colSpan: 2,
    section: "Schedule: Night Before",
    placeholder: '{"instructions": "...", "supplements": [], "duration_min": 60}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the night-before preparation block. Return JSON: {\"instructions\": \"detailed steps\", \"supplements\": [\"supplement_ids\"], \"duration_min\": number, \"notes\": \"optional tips\"}. Focus on sleep prep, meal timing, and supplements.",
  },
  {
    key: "wake_up",
    label: "Wake Up",
    ...
    placeholder: '{"instructions": "...", "activities": [], "duration_min": 15}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the wake-up routine (first 15 min). Return JSON: {\"instructions\": \"detailed steps\", \"activities\": [\"activity_ids\"], \"duration_min\": number, \"notes\": \"tips\"}. Include hydration, light exposure, breathwork.",
  },
  {
    key: "morning",
    ...
    colSpan: 2,
    section: "Schedule: Morning",
    placeholder: '{"instructions": "...", "activities": ["walking"], "duration_min": 30}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the morning activity block. Return JSON: {\"instructions\": \"detailed steps\", \"activities\": [\"activity_ids\"], \"duration_min\": number, \"notes\": \"tips\"}. Include exercise, cold exposure, or journaling as appropriate.",
  },
  {
    key: "breakfast",
    label: "Breakfast",
    ...
    colSpan: 2,
    section: "Schedule: Morning",
    placeholder: '{"instructions": "...", "recipes": [], "supplements": [], "duration_min": 20}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the breakfast block. Return JSON: {\"instructions\": \"detailed meal\", \"recipes\": [\"recipe_ids\"], \"supplements\": [\"supplement_ids\"], \"duration_min\": number}. Include specific foods and nutrients.",
  },
  {
    key: "mid_morning",
    label: "Mid-Morning",
    ...
    placeholder: '{"instructions": "...", "duration_min": 30}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the mid-morning block. Return JSON: {\"instructions\": \"detailed steps\", \"activities\": [], \"duration_min\": number, \"notes\": \"tips\"}. Include snacks, hydration, movement breaks.",
  },
  {
    key: "lunch",
    label: "Lunch",
    ...
    colSpan: 2,
    section: "Schedule: Midday",
    placeholder: '{"instructions": "...", "recipes": [], "supplements": [], "duration_min": 30}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the lunch block. Return JSON: {\"instructions\": \"detailed meal\", \"recipes\": [\"recipe_ids\"], \"supplements\": [\"supplement_ids\"], \"duration_min\": number}.",
  },
  {
    key: "afternoon",
    label: "Afternoon",
    ...
    showInEdit: true,
    colSpan: 2,
    section: "Schedule: Afternoon",
    placeholder: '{"instructions": "...", "activities": [], "duration_min": 30}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the afternoon block. Return JSON: {\"instructions\": \"detailed steps\", \"activities\": [\"activity_ids\"], \"duration_min\": number, \"notes\": \"tips\"}. Include activity, hydration, focus work.",
  },
  {
    key: "pre_dinner",
    label: "Pre-Dinner",
    ...
    showInEdit: true,
    colSpan: 2,
    section: "Schedule: Evening",
    placeholder: '{"instructions": "...", "activities": ["sauna"], "duration_min": 30}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the pre-dinner block. Return JSON: {\"instructions\": \"detailed steps\", \"activities\": [\"activity_ids\"], \"supplements\": [\"supplement_ids\"], \"duration_min\": number}. Include light exercise, sauna, or wind-down.",
  },
  {
    key: "dinner",
    label: "Dinner",
    ...
    colSpan: 2,
    section: "Schedule: Evening",
    placeholder: '{"instructions": "...", "recipes": [], "duration_min": 30}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the dinner block. Return JSON: {\"instructions\": \"detailed meal\", \"recipes\": [\"recipe_ids\"], \"duration_min\": number, \"notes\": \"timing tips\"}. Dinner should finish 3 hours before sleep.",
  },
  {
    key: "evening",
    ...
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the evening wind-down block. Return JSON: {\"instructions\": \"detailed steps\", \"supplements\": [\"supplement_ids\"], \"duration_min\": number}. Include blue light blocking, relaxation, supplements.",
  },
  {
    key: "sleep",
    label: "Sleep",
    ...
    showInEdit: true,
    colSpan: 2,
    section: "Schedule: Sleep",
    placeholder: '{"instructions": "...", "duration_min": 480, "notes": "Target: 10pm-6am"}',
    aiSuggest: true,
    aiPrompt:
      "For a '{category}' protocol called '{name}', write the sleep block. Return JSON: {\"instructions\": \"environment and conditions\", \"duration_min\": number, \"notes\": \"target times\"}. Include room temp, darkness, duration target.",
  },
  // ── Summary fields ──────────────────────────────────────────
  {
    key: "total_calories",
  ...
  },
  {
    ...
    colSpan: 2,
    section: "Summary",
    placeholder: '["Improved sleep", "Toxin removal"]',
    aiSuggest: true,
    aiPrompt:
      "List 4-6 key health benefits of a '{category}' protocol called '{name}'. Return as a JSON string array.",
  },
  {
    key: "target_symptoms",
    ...
    colSpan: 2,
    section: "Summary",
    placeholder: '["Fatigue", "Brain fog"]',
    aiSuggest: true,
    aiPrompt:
      "List 3-5 symptoms that a '{category}' protocol called '{name}' is designed to address. Return as a JSON string array.",
  },
  {
    key: "contraindications",
    label: "Contraindications",
    ...
    colSpan: 2,
    section: "Summary",
    placeholder: '["Pregnancy", "Heart conditions"]',
    aiSuggest: true,
    aiPrompt:
      "List health conditions where this '{category}' protocol should be avoided. Return as a JSON string array.",
  },
  {
    key: "equipment_needed",
    label: "Equipment Needed",
    ...
    colSpan: 2,
    section: "Summary",
    placeholder: '["Sauna", "Yoga mat"]',
  },
  {
    key: "elements_targeted",
    label: "Elements Targeted",
    type: "json",
    showInDetail: true,
    showInEdit: true,
    colSpan: 2,
    section: "Summary",
    placeholder: '{"vitamin_d": "replenish", "magnesium": "supplement"}',
  },
  {
    key: "source",
    label: "Source",
    type: "select",
    options: ["healthscan", "community", "expert"],
    showInList: true,
    showInDetail: true,
    showInEdit: true,
    section: "Metadata",
